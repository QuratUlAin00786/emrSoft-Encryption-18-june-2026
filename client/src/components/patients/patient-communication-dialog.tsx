...
const VOICE_CALL_SCRIPTS: Record<string, string> = {
  appointment_reminder: "Hello, this is a friendly reminder from EmrSoft about your upcoming appointment. Please contact us if you need to reschedule or have any questions. Thank you!",
  medication_reminder: "Hello, this is a reminder from EmrSoft to take your medication as prescribed. Please follow your doctor's instructions carefully. If you have any concerns, please contact your healthcare provider. Stay healthy!",
  follow_up_reminder: "Hello, this is a follow-up reminder from EmrSoft. We want to check in with you regarding your recent appointment or treatment. Please feel free to contact us if you have any questions or need further assistance.",
  billing_notice: "Hello, this is a billing notice from EmrSoft. Your payment for the recent service is due soon. Please ensure timely payment to avoid any interruptions in service. Thank you for your prompt attention.",
  health_check: "Hello, this is a health check-in call from EmrSoft. We are reaching out to see how you are doing and to offer any support you may need. Please contact us if you have any health concerns or require assistance.",
  emergency_alert: "Attention, this is an important emergency alert from EmrSoft. Please take immediate action as advised by your healthcare provider. If you require urgent assistance, call emergency services or contact us right away.",
  preventive_care: "Hello, this is a preventive care reminder from EmrSoft. It's time to schedule your regular health screening or check-up. Please contact us to book an appointment and stay proactive about your health."
};

const SMS_MESSAGE_TEMPLATES: Record<string, string> = {
  appointment_reminder: "Hello [Patient Name], this is a friendly reminder from EmrSoft Healthcare EMR about your upcoming appointment on [Date] at [Time]. Please contact us at [Contact Number] if you need to reschedule or have any questions. Thank you!",
  medication_reminder: "Hello [Patient Name], this is a reminder from EmrSoft Healthcare EMR to take your medication as prescribed. Please follow your doctor's instructions carefully. If you have any concerns, please contact your healthcare provider at [Contact Number]. Stay healthy!",
  follow_up_reminder: "Hello [Patient Name], this is a follow-up reminder from EmrSoft Healthcare EMR regarding your recent appointment or treatment. Please feel free to contact us at [Contact Number] if you have any questions or need further assistance.",
  billing_notice: "Hello [Patient Name], this is a billing notice from EmrSoft Healthcare EMR. Your payment for the recent service is due on [Due Date]. Please ensure timely payment to avoid any interruptions in service. Contact us at [Contact Number] for assistance.",
  health_check: "Hello [Patient Name], this is a health check-in call from EmrSoft Healthcare EMR. We are reaching out to see how you are doing and to offer any support you may need. Please contact us at [Contact Number] if you have any health concerns or require assistance.",
  emergency_alert: "Attention [Patient Name], this is an important emergency alert from EmrSoft Healthcare EMR. Please take immediate action as advised by your healthcare provider. If you require urgent assistance, call emergency services or contact us at [Contact Number] immediately.",
  preventive_care: "Hello [Patient Name], this is a preventive care reminder from EmrSoft Healthcare EMR. It's time to schedule your regular health screening or check-up. Please contact us at [Contact Number] to book an appointment and stay proactive about your health."
};

const EMAIL_MESSAGE_TEMPLATES: Record<string, string> = {
  appointment_reminder: "Dear [Patient Name],\n\nThis is a friendly reminder from EmrSoft Healthcare EMR about your upcoming appointment scheduled on [Date] at [Time].\n\nPlease contact us at [Contact Number] if you need to reschedule or have any questions.\n\nThank you for choosing EmrSoft Healthcare.\n\nBest regards,\nEmrSoft Healthcare Team",
  medication_reminder: "Dear [Patient Name],\n\nThis is a reminder from EmrSoft Healthcare EMR to take your medication as prescribed by your doctor.\n\nPlease follow your doctor's instructions carefully. If you have any concerns or questions about your medication, please contact your healthcare provider at [Contact Number].\n\nStay healthy!\n\nBest regards,\nEmrSoft Healthcare Team",
  follow_up_reminder: "Dear [Patient Name],\n\nThis is a follow-up reminder from EmrSoft Healthcare EMR regarding your recent appointment or treatment.\n\nWe want to ensure your recovery is progressing well. Please feel free to contact us at [Contact Number] if you have any questions or need further assistance.\n\nBest regards,\nEmrSoft Healthcare Team",
  billing_notice: "Dear [Patient Name],\n\nThis is a billing notice from EmrSoft Healthcare EMR.\n\nYour payment for the recent service is due on [Due Date]. Please ensure timely payment to avoid any interruptions in service.\n\nFor any billing queries or assistance, please contact us at [Contact Number].\n\nThank you for your prompt attention.\n\nBest regards,\nEmrSoft Healthcare Billing Team",
  health_check: "Dear [Patient Name],\n\nThis is a health check-in from EmrSoft Healthcare EMR.\n\nWe are reaching out to see how you are doing and to offer any support you may need. Your wellbeing is important to us.\n\nPlease contact us at [Contact Number] if you have any health concerns or require assistance.\n\nBest regards,\nEmrSoft Healthcare Team",
  emergency_alert: "URGENT - Dear [Patient Name],\n\nThis is an important emergency alert from EmrSoft Healthcare EMR.\n\nPlease take immediate action as advised by your healthcare provider. If you require urgent assistance, call emergency services immediately or contact us at [Contact Number].\n\nYour health and safety are our priority.\n\nBest regards,\nEmrSoft Healthcare Team",
  preventive_care: "Dear [Patient Name],\n\nThis is a preventive care reminder from EmrSoft Healthcare EMR.\n\nIt's time to schedule your regular health screening or check-up. Preventive care is essential for maintaining good health and detecting potential issues early.\n\nPlease contact us at [Contact Number] to book an appointment and stay proactive about your health.\n\nBest regards,\nEmrSoft Healthcare Team"
};

const WHATSAPP_MESSAGE_TEMPLATES: Record<string, string> = {
  appointment_reminder: "Hello [Patient Name], this is a WhatsApp reminder from EmrSoft Healthcare about your upcoming appointment on [Date] at [Time]. Please reply to this message or contact us at [Contact Number] if you need to reschedule. Thank you!",
  medication_reminder: "Hello [Patient Name], this is a WhatsApp reminder from EmrSoft Healthcare to take your medication as prescribed. If you have any concerns, please contact your healthcare provider at [Contact Number]. Stay healthy!",
  follow_up_reminder: "Hello [Patient Name], this is a follow-up message from EmrSoft Healthcare regarding your recent appointment or treatment. Please reply to this message or contact us at [Contact Number] if you have any questions.",
  billing_notice: "Hello [Patient Name], this is a billing notice from EmrSoft Healthcare. Your payment for the recent service is due on [Due Date]. Please contact us at [Contact Number] for assistance.",
  health_check: "Hello [Patient Name], this is a health check-in from EmrSoft Healthcare. We are reaching out to see how you are doing. Please reply to this message or contact us at [Contact Number] if you need any assistance.",
  emergency_alert: "URGENT [Patient Name]: This is an important alert from EmrSoft Healthcare. Please take immediate action as advised by your healthcare provider. If you require urgent assistance, call emergency services or contact us at [Contact Number] immediately.",
  preventive_care: "Hello [Patient Name], this is a preventive care reminder from EmrSoft Healthcare. It's time to schedule your regular health screening or check-up. Please contact us at [Contact Number] to book an appointment."
};
