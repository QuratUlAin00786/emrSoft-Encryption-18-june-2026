 ...
 * Used to automatically populate currency_code, currency_symbol, and language_code
 * when a user selects a country during organization creation
 */
...
export const countryDataMap: Record<string, CountryData> = {
  // Middle East
  "AE": { country_code: "AE", country_name: "United Arab Emirates", currency_code: "AED", currency_symbol: "د.إ", language_code: "ar-AE", language_name: "Arabic" },
  ...
  // United Kingdom
  "GB": { country_code: "GB", country_name: "United Kingdom", currency_code: "GBP", currency_symbol: "£", language_code: "en-GB", language_name: "British" },
  "IE": { country_code: "IE", country_name: "Ireland", currency_code: "EUR", currency_symbol: "€", language_code: "en-IE", language_name: "English" },

  // Europe - Eurozone
  "DE": { country_code: "DE", country_name: "Germany", currency_code: "EUR", currency_symbol: "€", language_code: "de-DE", language_name: "German" },
  "FR": { country_code: "FR", country_name: "France", currency_code: "EUR", currency_symbol: "€", language_code: "fr-FR", language_name: "French" },
  "IT": { country_code: "IT", country_name: "Italy", currency_code: "EUR", currency_symbol: "€", language_code: "it-IT", language_name: "Italian" },
  "ES": { country_code: "ES", country_name: "Spain", currency_code: "EUR", currency_symbol: "€", language_code: "es-ES", language_name: "Spanish" },
  "NL": { country_code: "NL", country_name: "Netherlands", currency_code: "EUR", currency_symbol: "€", language_code: "nl-NL", language_name: "Dutch" },
  "BE": { country_code: "BE", country_name: "Belgium", currency_code: "EUR", currency_symbol: "€", language_code: "nl-BE", language_name: "Dutch" },
  "AT": { country_code: "AT", country_name: "Austria", currency_code: "EUR", currency_symbol: "€", language_code: "de-AT", language_name: "German" },
  "PT": { country_code: "PT", country_name: "Portugal", currency_code: "EUR", currency_symbol: "€", language_code: "pt-PT", language_name: "Portuguese" },
  "GR": { country_code: "GR", country_name: "Greece", currency_code: "EUR", currency_symbol: "€", language_code: "el-GR", language_name: "Greek" },
  "FI": { country_code: "FI", country_name: "Finland", currency_code: "EUR", currency_symbol: "€", language_code: "fi-FI", language_name: "Finnish" },
  "LU": { country_code: "LU", country_name: "Luxembourg", currency_code: "EUR", currency_symbol: "€", language_code: "fr-LU", language_name: "French" },
  "MT": { country_code: "MT", country_name: "Malta", currency_code: "EUR", currency_symbol: "€", language_code: "en-MT", language_name: "English" },
  "CY": { country_code: "CY", country_name: "Cyprus", currency_code: "EUR", currency_symbol: "€", language_code: "el-CY", language_name: "Greek" },
  "SK": { country_code: "SK", country_name: "Slovakia", currency_code: "EUR", currency_symbol: "€", language_code: "sk-SK", language_name: "Slovak" },
  "SI": { country_code: "SI", country_name: "Slovenia", currency_code: "EUR", currency_symbol: "€", language_code: "sl-SI", language_name: "Slovenian" },
  "EE": { country_code: "EE", country_name: "Estonia", currency_code: "EUR", currency_symbol: "€", language_code: "et-EE", language_name: "Estonian" },
  "LV": { country_code: "LV", country_name: "Latvia", currency_code: "EUR", currency_symbol: "€", language_code: "lv-LV", language_name: "Latvian" },
  "LT": { country_code: "LT", country_name: "Lithuania", currency_code: "EUR", currency_symbol: "€", language_code: "lt-LT", language_name: "Lithuanian" },

  // Europe - Non-Eurozone
  "CH": { country_code: "CH", country_name: "Switzerland", currency_code: "CHF", currency_symbol: "CHF", language_code: "de-CH", language_name: "German" },
  "SE": { country_code: "SE", country_name: "Sweden", currency_code: "SEK", currency_symbol: "kr", language_code: "sv-SE", language_name: "Swedish" },
  "NO": { country_code: "NO", country_name: "Norway", currency_code: "NOK", currency_symbol: "kr", language_code: "no-NO", language_name: "Norwegian" },
  "DK": { country_code: "DK", country_name: "Denmark", currency_code: "DKK", currency_symbol: "kr", language_code: "da-DK", language_name: "Danish" },
  "PL": { country_code: "PL", country_name: "Poland", currency_code: "PLN", currency_symbol: "zł", language_code: "pl-PL", language_name: "Polish" },
  "CZ": { country_code: "CZ", country_name: "Czech Republic", currency_code: "CZK", currency_symbol: "Kč", language_code: "cs-CZ", language_name: "Czech" },
  "HU": { country_code: "HU", country_name: "Hungary", currency_code: "HUF", currency_symbol: "Ft", language_code: "hu-HU", language_name: "Hungarian" },
  "RO": { country_code: "RO", country_name: "Romania", currency_code: "RON", currency_symbol: "lei", language_code: "ro-RO", language_name: "Romanian" },
  "BG": { country_code: "BG", country_name: "Bulgaria", currency_code: "BGN", currency_symbol: "лв", language_code: "bg-BG", language_name: "Bulgarian" },
  "HR": { country_code: "HR", country_name: "Croatia", currency_code: "EUR", currency_symbol: "€", language_code: "hr-HR", language_name: "Croatian" },
...
/**
 * Get all countries as an array sorted by country name
 * @returns Array of CountryData objects
 */
export const getAllCountries = (): CountryData[] => {
  return Object.values(countryDataMap).sort((a, b) => 
...
/**
 * Country group interface for organizing countries by region
 */
 ...
 */
export const getFilteredCountriesForOrganization = (): CountryGroup[] => {
  // UAE countries
  const uaeCountries = [
  ...
  const europeanCountries = [
    countryDataMap["GB"], // United Kingdom
    countryDataMap["IE"], // Ireland
    countryDataMap["DE"], // Germany
    countryDataMap["FR"], // France
    countryDataMap["IT"], // Italy
    countryDataMap["ES"], // Spain
    countryDataMap["NL"], // Netherlands
    countryDataMap["BE"], // Belgium
    countryDataMap["AT"], // Austria
    countryDataMap["PT"], // Portugal
    countryDataMap["GR"], // Greece
    countryDataMap["FI"], // Finland
    countryDataMap["LU"], // Luxembourg
    countryDataMap["MT"], // Malta
    countryDataMap["CY"], // Cyprus
    countryDataMap["SK"], // Slovakia
    countryDataMap["SI"], // Slovenia
    countryDataMap["EE"], // Estonia
    countryDataMap["LV"], // Latvia
    countryDataMap["LT"], // Lithuania
    countryDataMap["CH"], // Switzerland
    countryDataMap["SE"], // Sweden
    countryDataMap["NO"], // Norway
    countryDataMap["DK"], // Denmark
    countryDataMap["PL"], // Poland
    countryDataMap["CZ"], // Czech Republic
    countryDataMap["HU"], // Hungary
    countryDataMap["RO"], // Romania
    countryDataMap["BG"], // Bulgaria
    countryDataMap["HR"], // Croatia
  ].filter(Boolean).sort((a, b) => a.country_name.localeCompare(b.country_name));

  const groups: CountryGroup[] = [];

  if (uaeCountries.length > 0) {
    groups.push({
      label: "UAE",
